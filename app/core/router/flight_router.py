...
class FlightRouter:
    def __init__(self):
        ...
        self.router.add_api_route("/opera",self.enum_val,methods=["GET"])
    ...
    async def enum_val(self,opera: Airlines=Query(...,description="Nombre de aerolínea que opera"),tipo_vuelo:TipoVuelo =Query(...,description="Tipo de vuelo, I =Internacional, N =Nacional"), mes :int = Query(...,description="Número del mes de operacion del vuelo",ge=1,le=12)):
         return opera
