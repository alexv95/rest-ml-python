...
class FlightRouter:
    ...
    async def flight_multiparam(self,
                                fecha_vuelo : str = Query (...,description="Fecha y hora programada del vuelo",min_length=4,max_length=100),
                                ...
                                vuelo_operacion : int = Query(...,description="Número de vuelo de operación del vuelo",ge=100,le=999),
